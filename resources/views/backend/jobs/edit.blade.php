            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form action="" class="form-horizontal" method="POST" accept="{{url("admin/jobs/edit")}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{$getRecord->job_title}}" class="form-control" required placeholder="Enter Job Title">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{$getRecord->min_salary}}" class="form-control" required placeholder="Enter Min Salary">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{$getRecord->max_salary}}" class="form-control" required placeholder="Enter Max Salary">
                            </div>
                        </div>
