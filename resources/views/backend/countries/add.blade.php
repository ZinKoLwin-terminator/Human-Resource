            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form action="" class="form-horizontal" method="POST" accept="{{url("admin/countries/add")}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{old('country_name')}}" class="form-control" required placeholder="Enter Country Name">
                            </div>
                        </div>
