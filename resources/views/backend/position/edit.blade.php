            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form action="" class="form-horizontal" method="POST" accept="{{url("admin/position/edit/".$getRecord->id)}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{$getRecord->position_name}}" class="form-control" required placeholder="Enter Position Name">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{$getRecord->daily_rate}}" class="form-control" required placeholder="Enter Daily Rate">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{$getRecord->monthly_rate}}" class="form-control" required placeholder="Enter Monthly Rate">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{$getRecord->working_days_per_month}}" class="form-control" required placeholder="Enter Working Days Per Month">
                            </div>
                        </div>
