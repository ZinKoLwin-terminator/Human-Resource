            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form action="" class="form-horizontal" method="POST" accept="{{url("admin/departments/edit/".$getRecord->id)}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{$getRecord->department_name}}" class="form-control" required placeholder="Enter Department Name">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            @foreach ($getLocations as $location)
                                <option value="{{$location->id}}" {{($getRecord->locations_id==$location->id)?"selected":""}}>{{$location->street_address}}</option>
                            @endforeach
                            </select>
                            </div>
                        </div>
