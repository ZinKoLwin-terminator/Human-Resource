            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form action="" class="form-horizontal" method="POST" accept="{{url("admin/locations/add")}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{old('street_address')}}" class="form-control" required placeholder="Enter Street Address">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{old('postal_code')}}" class="form-control" required placeholder="Enter Postal Code">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{old('city')}}" class="form-control" required placeholder="Enter City">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{old('state_provice')}}" class="form-control" required placeholder="Enter State Provice">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                               <select class="form-control" name="countries_id" id="">
                                <option value="" @required(true)>Select Country Name</option>
