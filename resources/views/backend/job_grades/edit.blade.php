            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form action="" class="form-horizontal" method="POST" accept="{{url("admin/job_grades/edit/".$getRecord->id)}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{$getRecord->grade_level}}" class="form-control" required placeholder="Enter Grade Level">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{$getRecord->lowest_sal}}" class="form-control" required placeholder="Enter Lowest Sal">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="{{$getRecord->highest_sal}}" class="form-control" required placeholder="Enter Highest Sal">
                            </div>
                        </div>
                       </div>
